...
Pod::Spec.new do |spec|
    ...
    spec.source       = { :git => "https://github.com/TransmitSecurity/identityVerification-ios-sdk", :tag => "#{spec.version}" }
    ...
    spec.vendored_frameworks = "Sources/IdentityVerification.xcframework*"
    ...
    spec.dependency "TSCoreSDK", "~> 1.0.17"
    spec.dependency "AccountProtection", "~> 2.0.6"
