...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/TransmitSecurity/core-ios-sdk.git", from: "2.1.9"),
        .package(url: "https://github.com/TransmitSecurity/accountprotection-ios-sdk.git", from: "2.1.9")
    ],
    targets: [
        .binaryTarget(
            name: "IdentityVerification",
