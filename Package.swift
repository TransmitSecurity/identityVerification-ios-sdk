...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/TransmitSecurity/core-ios-sdk.git", from: "2.1.3"),
        .package(url: "https://github.com/TransmitSecurity/accountprotection-ios-sdk.git", from: "2.1.3")
    ],
    targets: [
        .binaryTarget(
            name: "IdentityVerification",
